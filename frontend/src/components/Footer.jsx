      ...
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <p className="footer-desc">
            ...
            AddisDR is a modern platform that helps businesses simplify operations, manage customers, and grow digitally.
        ...
        <div className="footer-social">
          ...
          <div className="social-links">
            ...
            <a href="https://www.instagram.com/visiontonet/" className="social-link" target="_blank" rel="noopener" aria-label="Instagram">
              <svg viewBox="0 0 24 24" fill="currentColor">
                <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" fill="none" stroke="#071220" strokeWidth="1.5"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
              </svg>
              Instagram
            </a>
